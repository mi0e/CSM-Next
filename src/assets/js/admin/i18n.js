export const translations = {
  zh: {
    ...
    backHome: '返回前台', openOriginalAdmin: '打开原站后台', menu: '菜单', theme: '切换主题', language: 'Switch to English',
    ...
    tags: '标签', note: '备注', price: '价格', expire: '到期', bandwidth: '带宽', traffic: '流量',
  ...
  en: {
    ...
    backHome: 'Back to site', openOriginalAdmin: 'Open original admin', menu: 'Menu', theme: 'Toggle theme', language: '切换到中文',
    ...
    tags: 'Tags', note: 'Note', price: 'Price', expire: 'Expire', bandwidth: 'Bandwidth', traffic: 'Traffic',
